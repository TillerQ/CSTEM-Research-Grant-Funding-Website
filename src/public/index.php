...
<form method="POST">
    ...
    <?php
        ...
        // code to execute if the user is logged in
            ...
            $username = '<div style="position:absolute; bottom:-22px; left:-5px; font-size:15px; font-family:Arial, sans-serif">User: ' .$name. '</div>';
            $emailview = '<div style="position:absolute; bottom:-50px; left:-5px; font-size:15px; font-family:Arial, sans-serif">Email: '.$email.'</div>';
